          ...
          class u extends r.EmbedBlot {
            ...
            insertAt(t, e, n) {
              ...
              (s.forEach((t) => {
                ...
                i &&
                  this.parent.insertBefore(this.scroll.create("text", i), o));
            }
          }
          function h(t) {
            let e =
          ...
          class f extends u.A {
            ...
            addBinding(t) {
              ...
              const r = (function (t) {
                ...
                return (
                  t.shortKey && ((t[d] = t.shortKey), delete t.shortKey),
                  t
                );
              })(t);
              null != r
            ...
            d = class {
              ...
              values() {
                return Object.keys(this.attributes).reduce(
                  (t, e) => (
                    (t[e] = this.attributes[e].value(this.domNode)),
                    t
                  ),
                  {},
                );
          ...
          const O = S,
            T = class t extends m {
              ...
              update(t, e) {
                t.some(
                  (t) =>
                    "characterData" === t.type && t.target === this.domNode,
                ) && (this.text = this.statics.value(this.domNode));
              }
              value() {
                return this.text;
      ...
      (function () {
        ...
        class G extends D.Ay {
          static create(t) {
            const e = super.create(t);
            return (
              "string" == typeof t && e.setAttribute("data-language", t),
              e
            );
          }
          static formats(t) {
