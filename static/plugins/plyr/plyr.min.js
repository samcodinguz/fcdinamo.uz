"object" == typeof navigator &&
  (function (e, t) {
    ...
    var x = {
      nullOrUndefined: C,
      object: A,
      number: (e) => k(e) === Number && !Number.isNaN(e),
      string: S,
      boolean: (e) => k(e) === Boolean,
      function: E,
      array: P,
      weakMap: (e) => T(e, WeakMap),
      nodeList: M,
      element: function (e) {
        return (
          null !== e &&
      ...
      textNode: (e) => k(e) === Text,
      event: (e) => T(e, Event),
      keyboardEvent: (e) => T(e, KeyboardEvent),
      cue: (e) => T(e, window.TextTrackCue) || T(e, window.VTTCue),
      track: (e) => T(e, TextTrack) || (!C(e) && S(e.kind)),
      promise: (e) => T(e, Promise) && E(e.then),
      url: function (e) {
    ...
    function j(e, t) {
      x.element(e) &&
        !x.empty(t) &&
        Object.entries(t)
          .filter(([, e]) => !x.nullOrUndefined(e))
          .forEach(([t, i]) => e.setAttribute(t, i));
    }
    function q(e, t, i) {
      const s = document.createElement(e);
      return (x.object(t) && j(s, t), x.string(i) && (s.textContent = i), s);
    }
    function D(e, t, i, s) {
      x.element(t) && t.appendChild(q(e, i, s));
    }
    function H(e) {
      x.nodeList(e) || x.array(e)
        ? Array.from(e).forEach(H)
        : x.element(e) &&
          x.element(e.parentNode) &&
          e.parentNode.removeChild(e);
    }
    function R(e) {
      if (!x.element(e)) return;
    ...
    function V(e, t) {
      ...
      return (
        e.split(",").forEach((e) => {
          ...
          switch (t.charAt(0)) {
            case ".":
              x.string(s.class) ? (i.class = `${s.class} ${n}`) : (i.class = n);
              break;
            case "#":
              i.id = t.replace("#", "");
              break;
    ...
    function U(e, t) {
      if (!x.element(e)) return;
      let i = t;
      (x.boolean(i) || (i = !e.hidden), (e.hidden = i));
    }
    function B(e, t, i) {
      if (x.nodeList(e)) return Array.from(e).map((e) => B(e, t, i));
      if (x.element(e)) {
        let s = "toggle";
        return (
    ...
    function X(e = null, t = !1) {
      x.element(e) && e.focus({ preventScroll: !0, focusVisible: t });
    }
    const Q = {
        "audio/ogg": "vorbis",
        "audio/wav": "1",
      ...
      J = {
        ...
        check(e, t) {
          const i = J[e] || "html5" !== t;
          return { api: i, ui: i && J.rangeInput };
        },
        pip:
        ...
        mime(e) {
          ...
          Object.keys(Q).includes(i) && (i += `; codecs="${Q[e]}"`);
          try {
    ...
    function Z(e, t, i, s = !1, n = !0, a = !1) {
      if (!e || !("addEventListener" in e) || x.empty(t) || !x.function(i))
        return;
      const l = t.split(" ");
      let r = a;
      (G && (r = { passive: n, capture: a }),
        l.forEach((t) => {
          (this &&
            this.eventListeners &&
            s &&
    ...
    function ee(e, t = "", i, s = !0, n = !1) {
      Z.call(this, e, t, i, !0, s, n);
    }
    function te(e, t = "", i, s = !0, n = !1) {
      Z.call(this, e, t, i, !1, s, n);
    }
    function ie(e, t = "", i, s = !0, n = !1) {
      const a = (...l) => {
        (te(e, t, a, s, n), i.apply(this, l));
      };
      Z.call(this, e, t, a, !0, s, n);
    }
    function se(e, t = "", i = !1, s = {}) {
      if (!x.element(e) || x.empty(t)) return;
    ...
    function ae() {
      return new Promise((e) =>
        this.ready
          ? setTimeout(e, 0)
          : ee.call(this, this.elements.container, "ready", e),
      ).then(() => {});
    }
    function le(e) {
      x.promise(e) && e.then(null, () => {});
    }
    function re(e) {
      return x.array(e) ? e.filter((t, i) => e.indexOf(t) === i) : e;
    }
    function oe(e, t) {
    ...
    function he(e) {
      if (!(x.array(e) || (x.string(e) && e.includes(":")))) return !1;
      return (x.array(e) ? e : e.split(":")).map(Number).every(x.number);
    }
    function de(e) {
    ...
    function me(e) {
      const t = (e) => (he(e) ? e.split(":").map(Number) : null);
      let i = t(e);
      if (
    ...
    function ge(e, t, i = 0.05) {
      const s = e / t,
        n = oe(Object.keys(ue), s);
      return Math.abs(n - s) <= i ? ue[n] : [e, t];
    }
    const fe = {
      getSources() {
        ...
        return Array.from(this.media.querySelectorAll("source")).filter((e) => {
          ...
          return !!x.empty(t) || J.mime.call(this, t);
        });
      },
      getQualityOptions() {
      ...
      setup() {
        ...
        ((e.options.speed = e.config.speed.options),
          x.empty(this.config.ratio) || pe.call(e),
          Object.defineProperty(e.media, "quality", {
            get() {
              const t = fe.getSources
                .call(e)
                  ...
                  ((e.media.src = i.getAttribute("src")),
                    ("none" !== a || l) &&
                      (e.once("loadedmetadata", () => {
                        ((e.speed = r), (e.currentTime = s), n || le(e.play()));
                      }),
                      e.media.load()));
                }
    ...
    const Ce = {
      ...
      Ae = {
        get(e = "", t = {}) {
          ...
          let i = $(t.i18n, e);
          if (x.empty(i)) return Object.keys(Ce).includes(e) ? Ce[e] : "";
    ...
    class Se {
      constructor(t) {
        (e(this, "get", (e) => {
          ...
          if (x.empty(t)) return null;
          const i = JSON.parse(t);
          return x.string(e) && e.length ? i[e] : i;
        }),
          e(this, "set", (e) => {
            if (!Se.supported || !this.enabled) return;
            if (!x.object(e)) return;
            let t = this.get();
            (x.empty(t) && (t = {}), _(t, e));
            try {
    ...
    function Ee(e, t = "text", i = !1) {
      return new Promise((s, n) => {
        try {
          const n = new XMLHttpRequest();
          if (!("withCredentials" in n)) return;
          (i && (n.withCredentials = !0),
    ...
    const Me = (e) => Math.trunc((e / 60 / 60) % 60, 10);
    function Ne(e = 0, t = !1, i = !1) {
      if (!x.number(e)) return Ne(void 0, t, i);
    ...
    const xe = {
      getIconUrl() {
        const e = new URL(this.config.iconUrl, window.location),
          ...
          i = e.host !== t || (ye.isIE && !window.svg4everybody);
        return { url: this.config.iconUrl, cors: i };
      },
      findElements() {
        try {
          return (
            (this.elements.controls = Y.call(
              this,
      ...
      createIcon(e, t) {
        const i = "http://www.w3.org/2000/svg",
          s = xe.getIconUrl.call(this),
          n = `${s.cors ? "" : s.url}#${this.config.iconPrefix}`,
          a = document.createElementNS(i, "svg");
        j(a, _(t, { "aria-hidden": "true", focusable: "false" }));
      ...
      createButton(e, t) {
        ...
        switch (
          ...
          Object.keys(i).includes("class")
            ? i.class.split(" ").includes(this.config.classNames.control) ||
              _(i, { class: `${i.class} ${this.config.classNames.control}` })
          ...
          case "play-large":
            ...
            break;
          default:
            (x.empty(n.label) && (n.label = s),
              x.empty(n.icon) && (n.icon = e));
        }
        const a = q(n.element);
        return (
          n.toggle
            ? (a.appendChild(
                xe.createIcon.call(this, n.iconPressed, {
                  class: "icon--pressed",
                }),
              ),
              a.appendChild(
                xe.createIcon.call(this, n.icon, {
                  class: "icon--not-pressed",
                }),
              ),
              a.appendChild(
                xe.createLabel.call(this, n.labelPressed, {
                  class: "label--pressed",
                }),
              ),
              a.appendChild(
                xe.createLabel.call(this, n.label, {
                  class: "label--not-pressed",
                }),
              ))
            : (a.appendChild(xe.createIcon.call(this, n.icon)),
              a.appendChild(xe.createLabel.call(this, n.label))),
          _(i, V(this.config.selectors.buttons[s], i)),
          j(a, i),
          "play" === s
            ? (x.array(this.elements.buttons[s]) ||
      ...
      createRange(e, t) {
        ...
        return (
          ...
          xe.updateRangeFill.call(this, i),
          w.setup(i),
          i
        );
      },
      ...
      createTime(e, t) {
        const i = V(this.config.selectors.display[e], t),
          s = q(
            "div",
            _(i, {
              class:
        ...
        (ee.call(
          ...
          (i) => {
            ...
            if ((i.preventDefault(), i.stopPropagation(), "keydown" === i.type))
              return;
            const s = z(e, '[role="menuitemradio"]');
            if (!s && [" ", "ArrowRight"].includes(i.key))
              xe.showMenuPanel.call(this, t, !0);
            else {
              let t;
              " " !== i.key &&
                ("ArrowDown" === i.key || (s && "ArrowRight" === i.key)
                  ? ((t = e.nextElementSibling),
                    x.element(t) || (t = e.parentNode.firstElementChild))
                  : ((t = e.previousElementSibling),
                    x.element(t) || (t = e.parentNode.lastElementChild)),
                X.call(this, t, !0));
            }
          },
          !1,
        ),
          ee.call(this, e, "keyup", (e) => {
            "Return" === e.key && xe.focusFirstMenuItem.call(this, null, !0);
          }));
      },
      createMenuItem({
        value: e,
        ...
        const l = V(this.config.selectors.inputs[i]),
          r = q(
            "button",
            _(l, {
              type: "button",
            ...
            set(e) {
              (e &&
                Array.from(r.parentNode.children)
                  .filter((e) => z(e, '[role="menuitemradio"]'))
          ...
          this.listeners.bind(
            ...
            (t) => {
              if (!x.keyboardEvent(t) || " " === t.key) {
                ...
                xe.showMenuPanel.call(this, "home", x.keyboardEvent(t));
              }
            },
            i,
            !1,
          ),
          xe.bindMenuItemShortcuts.call(this, r, i),
          t.appendChild(r));
      },
      formatTime(e = 0, t = !1) {
        if (!x.number(e)) return e;
        return Ne(e, Me(this.duration) > 0, t);
      },
      updateTimeDisplay(e = null, t = 0, i = !1) {
        x.element(e) && x.number(t) && (e.textContent = xe.formatTime(t, i));
      },
      updateVolume() {
        this.supported.ui &&
      ...
      setRange(e, t = 0) {
        x.element(e) && ((e.value = t), xe.updateRangeFill.call(this, e));
      },
      updateProgress(e) {
        if (!this.supported.ui || !x.event(e)) return;
        let t = 0;
        const i = (e, t) => {
          const i = x.number(t) ? t : 0,
            s = x.element(e) ? e : this.elements.display.buffer;
          if (x.element(s)) {
            s.value = i;
            const e = s.getElementsByTagName("span")[0];
            x.element(e) && (e.childNodes[0].nodeValue = i);
          }
        };
        if (e)
          switch (e.type) {
              ...
              ((s = this.currentTime),
                ...
                (t =
                  0 === s || 0 === n || Number.isNaN(s) || Number.isNaN(n)
                    ...
                    : ((s / n) * 100).toFixed(2)),
                "timeupdate" === e.type &&
                  xe.setRange.call(this, this.elements.inputs.seek, t));
              break;
            case "playing":
            case "progress":
      ...
      updateSeekTooltip(e) {
        ...
        if (x.event(e)) {
          const t = e.pageX - e.clientX;
          l = (100 / r.width) * (e.pageX - r.left - t);
        } else {
          if (!W(s, n)) return;
      ...
      durationUpdate() {
        ...
        if (this.duration >= 2 ** 32)
          return (
            U(this.elements.display.currentTime, !0),
            void U(this.elements.progress, !0)
          );
        x.element(this.elements.inputs.seek) &&
        ...
        const e = x.element(this.elements.display.duration);
        (!e &&
          ...
          this.config.markers.enabled && xe.setMarkers.call(this),
          xe.updateSeekTooltip.call(this));
      },
      toggleMenuButton(e, t) {
        U(this.elements.settings.buttons[e], !t);
      },
      updateSetting(e, t, i) {
        ...
        if ("captions" === e) n = this.currentTrack;
          ...
          if (
            ((n = x.empty(i) ? this[e] : i),
            x.empty(n) && (n = this.config[e].default),
            !x.empty(this.options[e]) && !this.options[e].includes(n))
          )
        ...
        if (
          (x.element(a) || (a = s && s.querySelector('[role="menu"]')),
          !x.element(a))
        )
          return;
        this.elements.settings.buttons[e].querySelector(
          `.${this.config.classNames.menu.value}`,
        ).innerHTML = xe.getLabel.call(this, e, n);
        const l = a && a.querySelector(`[value="${n}"]`);
        x.element(l) && (l.checked = !0);
      },
      getLabel(e, t) {
        switch (e) {
          case "speed":
            return 1 === t ? Ae.get("normal", this.config) : `${t}&times;`;
          case "quality":
            if (x.number(t)) {
              const e = Ae.get(`qualityLabel.${t}`, this.config);
      ...
      setQualityMenu(e) {
        if (!x.element(this.elements.settings.panels.quality)) return;
        const t = "quality",
          i =
        ...
        if (
          (xe.toggleMenuButton.call(this, t, s),
          R(i),
          ...
          return;
        const n = (e) => {
          const t = Ae.get(`qualityBadge.${e}`, this.config);
          return t.length ? xe.createBadge.call(this, t) : null;
        };
        (this.options.quality
          ...
          .forEach((e) => {
            xe.createMenuItem.call(this, {
              value: e,
              list: i,
              type: t,
              title: xe.getLabel.call(this, "quality", e),
              badge: n(e),
            });
          }),
          xe.updateSetting.call(this, t, i));
      },
      setCaptionsMenu() {
        if (!x.element(this.elements.settings.panels.captions)) return;
        const e = "captions",
          t =
            this.elements.settings.panels.captions.querySelector(
              '[role="menu"]',
            ),
          i = $e.getTracks.call(this),
          s = Boolean(i.length);
        if (
          (xe.toggleMenuButton.call(this, e, s),
          R(t),
          xe.checkMenu.call(this),
          !s)
        )
        ...
        const n = i.map((e, i) => ({
          ...
          title: $e.getLabel.call(this, e),
          badge:
            e.language && xe.createBadge.call(this, e.language.toUpperCase()),
          list: t,
          type: "language",
        }));
        (n.unshift({
          ...
          n.forEach(xe.createMenuItem.bind(this)),
          xe.updateSetting.call(this, e, t));
      },
      setSpeedMenu() {
        if (!x.element(this.elements.settings.panels.speed)) return;
        const e = "speed",
          t =
        ...
        const i = !x.empty(this.options.speed) && this.options.speed.length > 1;
        (xe.toggleMenuButton.call(this, e, i),
          R(t),
          xe.checkMenu.call(this),
          i &&
            (this.options.speed.forEach((i) => {
              xe.createMenuItem.call(this, {
                ...
                list: t,
                type: e,
                title: xe.getLabel.call(this, "speed", i),
              });
            }),
            xe.updateSetting.call(this, e, t)));
      },
      checkMenu() {
        const { buttons: e } = this.elements.settings,
          t = !x.empty(e) && Object.values(e).some((e) => !e.hidden);
        U(this.elements.settings.menu, !t);
      },
      ...
      toggleMenu(e) {
        ...
        if (!x.element(t) || !x.element(i)) return;
        const { hidden: s } = t;
        let n = s;
        if (x.boolean(e)) n = e;
        else if (x.keyboardEvent(e) && "Escape" === e.key) n = !1;
        else if (x.event(e)) {
          const s = x.function(e.composedPath) ? e.composedPath()[0] : e.target,
            a = t.contains(s);
          if (a || (!a && e.target !== i && n)) return;
        }
        (i.setAttribute("aria-expanded", n),
          U(t, !n),
          B(this.elements.container, this.config.classNames.menu.open, n),
          n && x.keyboardEvent(e)
            ? xe.focusFirstMenuItem.call(this, null, !0)
            : n || s || X.call(this, i, x.keyboardEvent(e)));
      },
      getMenuSize(e) {
      ...
      showMenuPanel(e = "", t = !1) {
        ...
        if (J.transitions && !J.reducedMotion) {
          ...
          const e = xe.getMenuSize.call(this, i),
            t = (e) => {
              e.target === s &&
        ...
        (U(n, !0), U(i, !1), xe.focusFirstMenuItem.call(this, i, t));
      },
      setDownloadUrl() {
      ...
      create(e) {
        ...
        const c = q("div", V(this.config.selectors.controls.wrapper));
        this.elements.controls = c;
        const u = { class: "plyr__controls__item" };
        return (
          re(x.array(this.config.controls) ? this.config.controls : []).forEach(
            (l) => {
              if (
                ...
                const t = q("div", {
                  ...
                  i = q("div", V(this.config.selectors.progress));
                if (
                  (i.appendChild(
              ...
              if (
                ...
                if (
                  ((x.element(t) && c.contains(t)) ||
                    ((t = q(
                      "div",
                      _({}, u, { class: `${u.class} plyr__volume`.trim() }),
                    )),
                    (this.elements.volume = t),
                    c.appendChild(t)),
                  "mute" === l && t.appendChild(i.call(this, "mute")),
                  "volume" === l && !ye.isIos && !ye.isIPadOS)
                ) {
                  const i = { max: 1, step: 0.05, value: this.config.volume };
                  t.appendChild(
                    n.call(this, "volume", _(i, { id: `plyr-volume-${e.id}` })),
                  );
                }
              }
              if (
                ("captions" === l && c.appendChild(i.call(this, "captions", u)),
                "settings" === l && !x.empty(this.config.settings))
              ) {
                const s = q(
                  "div",
                  _({}, u, {
                ...
                (l.appendChild(r),
                  ...
                  this.config.settings.forEach((i) => {
                    const s = q(
                      "button",
                      _(V(this.config.selectors.buttons.settings), {
                        type: "button",
                    ...
                    (t.call(this, s, i),
                      ee.call(this, s, "click", () => {
                        o.call(this, i, !1);
                      }));
                    const n = q("span", null, Ae.get(i, this.config)),
                      l = q("span", {
                    ...
                    (u.appendChild(
                      q("span", { "aria-hidden": !0 }, Ae.get(i, this.config)),
                    ),
                      u.appendChild(
                        q(
                          "span",
                          { class: this.config.classNames.hidden },
                          Ae.get("menuBack", this.config),
                        ),
                      ),
                      ee.call(
                        this,
              ...
              if (
                ("pip" === l && J.pip && c.appendChild(i.call(this, "pip", u)),
                "airplay" === l &&
                  J.airplay &&
                ...
                (!x.url(t) &&
                  this.isEmbed &&
                  _(e, { icon: `logo-${this.provider}`, label: this.provider }),
          ...
          this.isHTML5 && l.call(this, fe.getQualityOptions.call(this)),
          r.call(this),
          c
        );
      },
      inject() {
        if (this.config.loadSprite) {
          const e = xe.getIconUrl.call(this);
          e.cors && Pe(e.url, "sprite-plyr");
        }
        ...
        if (
          (s[x.element(e) ? "insertAdjacentElement" : "insertAdjacentHTML"](
            "afterbegin",
            e,
          ),
          x.element(this.elements.controls) || xe.findElements.call(this),
          ...
          Object.values(this.elements.buttons)
            .filter(Boolean)
            .forEach((t) => {
              x.array(t) || x.nodeList(t)
                ? Array.from(t).filter(Boolean).forEach(e)
                : e(t);
            });
        }
        if ((ye.isEdge && I(s), this.config.tooltips.controls)) {
          const { classNames: e, selectors: t } = this.config,
            i = `${t.controls.wrapper} ${t.labels} .${e.hidden}`,
            s = K.call(this, i);
          Array.from(s).forEach((e) => {
            (B(e, this.config.classNames.hidden, !1),
              B(e, this.config.classNames.tooltip, !0));
          });
        }
      },
      setMediaMetadata() {
    ...
    const $e = {
        setup() {
          ...
          if (
            (x.element(this.elements.captions) ||
              ((this.elements.captions = q(
                "div",
                V(this.config.selectors.captions),
              )),
          ...
          if (
            (x.boolean(n) || ({ active: n } = this.config.captions),
            ...
            const e = this.config.captions.update
              ...
              : "removetrack";
            ee.call(this, this.media.textTracks, e, $e.update.bind(this));
          }
            ...
            e
              ...
              .forEach((e) => {
                (this.debug.log("Track added", e),
                  ...
                  ee.call(this, e, "cuechange", () =>
                    $e.updateCues.call(this),
                  ));
              }),
            ((a && this.language !== i) || !e.includes(n)) &&
              ($e.setLanguage.call(this, i), $e.toggle.call(this, t && a)),
            this.elements &&
              B(
          ...
          if (n !== i) {
            if (
              ...
              return (
                ...
                void $e.set.call(this, e.indexOf(t))
              );
            }
            (this.elements.buttons.captions &&
              (this.elements.buttons.captions.pressed = n),
              B(this.elements.container, s, n),
        ...
        setLanguage(e, t = !0) {
          ...
          const s = $e.getTracks.call(this),
            n = $e.findTrack.call(this, [i]);
          $e.set.call(this, s.indexOf(n), t);
        },
        getTracks(e = !1) {
        ...
        getLabel(e) {
          ...
          return (
            !x.track(t) &&
              J.textTracks &&
              this.captions.toggled &&
              (t = $e.getCurrentTrack.call(this)),
            x.track(t)
              ? x.empty(t.label)
                ? x.empty(t.language)
                  ? Ae.get("enabled", this.config)
                  : e.language.toUpperCase()
                : t.label
              : Ae.get("disabled", this.config)
          );
        },
        updateCues(e) {
          if (!this.supported.ui) return;
          ...
          let t = e;
          if (!t) {
            const e = $e.getCurrentTrack.call(this);
          ...
          if (i !== this.elements.captions.innerHTML) {
            ...
            const e = q("span", V(this.config.selectors.caption));
            ((e.innerHTML = i),
      ...
      je = "inline",
      qe = { html5: "html5", youtube: "youtube", vimeo: "vimeo" },
      De = "audio",
      He = "video";
    function Re() {}
    class Fe {
    ...
    class Ve {
      constructor(t) {
        (e(this, "onChange", () => {
          ...
          e(this, "toggleFallback", (e = !1) => {
            ...
            e
              ? (this.scrollPosition = {
                  ...
                  y: null !== (i = window.scrollY) && void 0 !== i ? i : 0,
                })
            ...
            if (
              ...
              const s = x.string(t.content) && t.content.includes(i);
              e
          ...
          e(this, "trapFocus", (e) => {
            if (ye.isIos || ye.isIPadOS || !this.active || "Tab" !== e.key)
              return;
          ...
          e(this, "enter", () => {
            this.supported &&
              (ye.isIos && this.player.config.fullscreen.iosNative
                ? this.player.isVimeo
      ...
      static get prefix() {
        ...
        return (
          ["webkit", "moz", "ms"].some(
            (t) =>
              !(
                !x.function(document[`${t}ExitFullscreen`]) &&
                !x.function(document[`${t}CancelFullScreen`])
              ) && ((e = t), !0),
          ),
          e
        );
      ...
      get target() {
        var e;
        return ye.isIos && this.player.config.fullscreen.iosNative
          ? this.player.media
          : null !== (e = this.player.elements.fullscreen) && void 0 !== e
            ? e
            : this.player.elements.container;
      }
    }
    ...
    const Be = {
      ...
      build() {
        ...
        (x.element(this.elements.controls) ||
          ...
          xe.durationUpdate.call(this),
          Be.checkPlaying.call(this),
          B(
            this.elements.container,
            this.config.classNames.pip.supported,
            J.pip && this.isHTML5 && this.isVideo,
          ),
          B(
            this.elements.container,
            this.config.classNames.airplay.supported,
            J.airplay && this.isHTML5,
          ),
          B(
            this.elements.container,
          ...
          (this.ready = !0),
          setTimeout(() => {
            se.call(this, this.media, "ready");
          }, 0),
          Be.setTitle.call(this),
          this.poster &&
            Be.setPoster.call(this, this.poster, !1).catch(() => {}),
          this.config.duration && xe.durationUpdate.call(this),
          this.config.mediaMetadata && xe.setMediaMetadata.call(this));
      },
      setTitle() {
        let e = Ae.get("play", this.config);
        if (
          ...
          const e = Y.call(this, "iframe");
          if (!x.element(e)) return;
          const t = x.empty(this.config.title) ? "video" : this.config.title,
            i = Ae.get("frameTitle", this.config);
        ...
        return t && this.poster
          ...
          : (this.media.setAttribute("data-poster", e),
            ...
            ae
              ...
              .then(() => Ue(e))
              .catch((t) => {
                throw (e === this.poster && Be.togglePoster.call(this, !1), t);
              })
              .then(() => {
                if (e !== this.poster)
                  throw new Error(
        ...
        (B(
          ...
          Array.from(this.elements.buttons.play || []).forEach((e) => {
            (Object.assign(e, { pressed: this.playing }),
              e.setAttribute(
                "aria-label",
                Ae.get(this.playing ? "pause" : "play", this.config),
              ));
          }),
      ...
      migrateStyles() {
        (Object.values({ ...this.media.style })
          .filter((e) => !x.empty(e) && x.string(e) && e.startsWith("--plyr"))
          .forEach((e) => {
          ...
          x.empty(this.media.style) && this.media.removeAttribute("style"));
      },
    };
    class We {
      constructor(t) {
        (e(this, "firstTouch", () => {
          ...
          e(this, "global", (e = !0) => {
            ...
            (t.config.keyboard.global &&
              Z.call(t, window, "keydown keyup", this.handleKey, e, !1),
              Z.call(t, document.body, "click", this.toggleMenu, e),
              ie.call(t, document.body, "touchstart", this.firstTouch));
          }),
          e(this, "container", () => {
            const { player: e } = this,
            ...
            (!t.keyboard.global &&
              t.keyboard.focused &&
              ee.call(e, i.container, "keydown keyup", this.handleKey, !1),
              ee.call(
                e,
                i.container,
                ...
                (t) => {
                  ...
                  (["touchstart", "touchmove", "mousemove"].includes(t.type) &&
                    (Be.toggleControls.call(e, !0), (a = e.touch ? 3e3 : 2e3)),
                    clearTimeout(s.controls),
                    (s.controls = setTimeout(
                      () => Be.toggleControls.call(e, !1),
                      a,
                    )));
                },
              ));
            ...
            ee.call(e, i.container, "enterfullscreen exitfullscreen", (t) => {
              const { target: s } = e.fullscreen;
              if (s !== i.container) return;
              if (!e.isEmbed && x.empty(e.config.ratio)) return;
              n();
              ("enterfullscreen" === t.type ? ee : te).call(
                e,
                window,
                "resize",
                a,
          ...
          e(this, "media", () => {
            const { player: e } = this,
              { elements: t } = e;
            if (
              (ee.call(e, e.media, "timeupdate seeking seeked", (t) =>
                xe.timeUpdate.call(e, t),
              ),
              ee.call(
                e,
                e.media,
                "durationchange loadeddata loadedmetadata",
                (t) => xe.durationUpdate.call(e, t),
              ),
              ...
              ee.call(e, e.media, "progress playing seeking seeked", (t) =>
                xe.updateProgress.call(e, t),
              ),
              ee.call(e, e.media, "volumechange", (t) =>
                xe.updateVolume.call(e, t),
              ),
              ee.call(
                e,
                e.media,
                "playing play pause ended emptied timeupdate",
                (t) => Be.checkPlaying.call(e, t),
              ),
              ee.call(e, e.media, "waiting canplay seeked playing", (t) =>
                Be.checkLoading.call(e, t),
              ),
              e.supported.ui && e.config.clickToPlay && !e.isAudio)
            ) {
              const i = Y.call(e, `.${e.config.classNames.video}`);
              if (!x.element(i)) return;
              ee.call(e, t.container, "click", (s) => {
            ...
            (e.supported.ui &&
              ...
              ee.call(e, e.media, "ratechange", () => {
                (xe.updateSetting.call(e, "speed"),
                  e.storage.set({ speed: e.speed }));
              }),
              ee.call(e, e.media, "qualitychange", (t) => {
                xe.updateSetting.call(e, "quality", null, t.detail.quality);
              }),
              ee.call(e, e.media, "ready qualitychange", () => {
                xe.setDownloadUrl.call(e);
              }));
            const i = e.config.events.concat(["keyup", "keydown"]).join(" ");
            ee.call(e, e.media, i, (i) => {
              let { detail: s = {} } = i;
              ("error" === i.type && (s = e.media.error),
                se.call(e, t.container, i.type, !0, s));
            });
          }),
          e(this, "proxy", (e, t, i) => {
            const { player: s } = this,
            ...
            let a = !0;
            (x.function(n) && (a = n.call(s, e)),
              !1 !== a && x.function(t) && t.call(s, e));
          }),
          e(this, "bind", (e, t, i, s, n = !0) => {
            const { player: a } = this,
              l = a.config.listeners[s],
              r = x.function(l);
            ee.call(a, e, t, (e) => this.proxy(e, i, s), n && !r);
          }),
          e(this, "controls", () => {
            const { player: e } = this,
              { elements: t } = e,
              i = ye.isIE ? "change" : "input";
            if (
              (t.buttons.play &&
                  ...
                  [" ", "Enter"].includes(t.key) &&
                    ("Enter" !== t.key
                      ? (t.preventDefault(),
                        t.stopPropagation(),
                        xe.toggleMenu.call(e, t))
                      : xe.focusFirstMenuItem.call(e, null, !0));
                },
                null,
                !1,
              ),
              this.bind(t.settings.menu, "keydown", (t) => {
                "Escape" === t.key && xe.toggleMenu.call(e, t);
              }),
              this.bind(t.inputs.seek, "mousedown mousemove", (e) => {
                const i = t.progress.getBoundingClientRect(),
                  s = e.pageX - e.clientX,
                  n = (100 / i.width) * (e.pageX - i.left - s);
              ...
              this.bind(
                ...
                (t) => {
                  ...
                  n && a
                    ? (i.removeAttribute(s), le(e.play()))
                    : !a && e.playing && (i.setAttribute(s, ""), e.pause());
                },
              ),
              ye.isIos)
            ) {
              const t = K.call(e, 'input[type="range"]');
              Array.from(t).forEach((e) => this.bind(e, i, (e) => I(e.target)));
            }
            (this.bind(
              t.inputs.seek,
              i,
              ...
              ye.isWebKit &&
                Array.from(K.call(e, 'input[type="range"]')).forEach((t) => {
                  this.bind(t, "input", (t) =>
                    xe.updateRangeFill.call(e, t.target),
                  );
                }),
              e.config.toggleInvert &&
                !x.element(t.display.duration) &&
                this.bind(t.display.currentTime, "click", () => {
                  0 !== e.currentTime &&
                    ((e.config.invertTime = !e.config.invertTime),
                    xe.timeUpdate.call(e));
                }),
              this.bind(
                t.inputs.volume,
                i,
              ...
              this.bind(t.controls, "focusin", () => {
                ...
                (B(t.controls, i.classNames.noTransition, !0),
                  Be.toggleControls.call(e, !0),
                  setTimeout(() => {
                    B(t.controls, i.classNames.noTransition, !1);
                  }, 0));
        ...
        if (c) {
          ...
          if (x.element(n)) {
            const { editable: s } = t.config.selectors,
              { seek: a } = i.inputs;
            if (n !== a && z(n, s)) return;
            if (" " === e.key && z(n, 'button, [role^="menuitem"]')) return;
          }
          switch (
            ([
              " ",
            ...
            e.exports = (function () {
              ...
              function r(t, i, s, n) {
                var a,
                  ...
                  d = s.before || e,
                  m = t.replace(/[\?|#].*$/, ""),
                  p = t.replace(/^(css|img|module|nomodule)!/, "");
                if (((n = n || 0), /(^css!|\.css$)/.test(m)))
                  ...
                  (o = c.createElement("img")).src = p;
                else if (
                  (((o = c.createElement("script")).src = p),
                  (o.async = void 0 === u || u),
                  (l = "noModule" in o),
                  /^module!/.test(m))
                ) {
                  if (!l) return i(t, "l");
                  o.type = "module";
                } else if (/^nomodule!/.test(m) && l) return i(t, "l");
                ((o.onload =
                  o.onerror =
                  o.onbeforeload =
                    function (e) {
                      ...
                      if ("e" == l) {
                        if ((n += 1) < h) return r(t, i, s, n);
                      } else if ("preload" == o.rel && "style" == o.as)
                        return (o.rel = "stylesheet");
                      i(t, l, e.defaultPrevented);
                    }),
                  !1 !== d(t, o) && c.head.appendChild(o));
              }
              function o(e, t, i) {
                var s,
                  n,
    ...
    const Ze = {
      setup() {
        const e = this;
        (B(e.elements.wrapper, e.config.classNames.embed, !0),
          (e.options.speed = e.config.speed.options),
          pe.call(e),
      ...
      ready() {
        ...
        const o = Ie({
          ...
          c = (function (e) {
            if (x.empty(e)) return null;
            if (x.number(Number(e))) return e;
            const t = e.match(/^.*(vimeo.com\/|video\/)(\d+).*/);
            return t ? t[2] : e;
          })(a),
          u = q("iframe"),
          h = be(e.config.urls.vimeo.iframe, c, o);
        if (
          ...
          x.empty(s) || u.setAttribute("referrerPolicy", s),
          i || !t.customControls)
        )
          (u.setAttribute("data-poster", e.poster), (e.media = F(u, e.media)));
        else {
          const t = q("div", {
            class: e.config.classNames.embedContainer,
            "data-poster": e.poster,
          });
          (t.appendChild(u), (e.media = F(t, e.media)));
        }
        (t.customControls ||
          Ee(be(e.config.urls.vimeo.api, h)).then((t) => {
            !x.empty(t) &&
              t.thumbnail_url &&
              Be.setPoster.call(e, t.thumbnail_url).catch(() => {});
          }),
          ...
          (e.media.play = () => (Ge.call(e, !0), e.embed.play())),
          (e.media.pause = () => (Ge.call(e, !1), e.embed.pause())),
          (e.media.stop = () => {
        ...
        Object.defineProperty(e.media, "playbackRate", {
          ...
          set(t) {
            e.embed
              .setPlaybackRate(t)
              .then(() => {
                ((m = t), se.call(e, e.media, "ratechange"));
              })
              .catch(() => {
                e.options.speed = [1];
              });
        ...
        Object.defineProperty(e.media, "volume", {
          ...
          set(t) {
            e.embed.setVolume(t).then(() => {
              ((p = t), se.call(e, e.media, "volumechange"));
            });
          },
        });
        ...
        Object.defineProperty(e.media, "muted", {
          get: () => g,
          set(t) {
            const i = !!x.boolean(t) && t;
            e.embed.setMuted(!!i || e.config.muted).then(() => {
              ((g = i), se.call(e, e.media, "volumechange"));
            });
          },
        });
        let f,
        ...
        (Object.defineProperty(e.media, "loop", {
          get: () => y,
          set(t) {
            const i = x.boolean(t) ? t : e.config.loop.active;
          ...
          Promise.all([e.embed.getVideoWidth(), e.embed.getVideoHeight()]).then(
            (t) => {
              const [i, s] = t;
              ((e.embed.ratio = ge(i, s)), pe.call(this));
            },
          ),
          ...
          e.embed.getVideoTitle().then((t) => {
            ((e.config.title = t), Be.setTitle.call(this));
          }),
          e.embed.getCurrentTime().then((t) => {
            ((d = t), se.call(e, e.media, "timeupdate"));
          }),
          e.embed.getDuration().then((t) => {
            ((e.media.duration = t), se.call(e, e.media, "durationchange"));
          }),
          e.embed.getTextTracks().then((t) => {
            ((e.media.textTracks = t), $e.setup.call(e));
          }),
          e.embed.on("cuechange", ({ cues: t = [] }) => {
            ...
            $e.updateCues.call(e, i);
          }),
          e.embed.on("loaded", () => {
            if (
              (e.embed.getPaused().then((t) => {
                (Ge.call(e, !t), t || se.call(e, e.media, "playing"));
              }),
              x.element(e.embed.element) && e.supported.ui)
            ) {
          ...
          e.embed.on("play", () => {
            (Ge.call(e, !0), se.call(e, e.media, "playing"));
          }),
          e.embed.on("pause", () => {
            Ge.call(e, !1);
          }),
          ...
          e.embed.on("progress", (t) => {
            ((e.media.buffered = t.percent),
              ...
              1 === Number.parseInt(t.percent, 10) &&
          ...
          e.embed.on("ended", () => {
            ((e.media.paused = !0), se.call(e, e.media, "ended"));
          }),
          e.embed.on("error", (t) => {
            ((e.media.error = t), se.call(e, e.media, "error"));
          }),
          t.customControls && setTimeout(() => Be.build.call(e), 0));
      },
    };
    function et(e) {
      (e && !this.embed.hasPlayed && (this.embed.hasPlayed = !0),
    ...
    const it = {
        setup() {
          if (
            ...
            ((window.onYouTubeIframeAPIReady = () => {
              (x.function(e) && e(), it.ready.call(this));
            }),
        ...
        getTitle(e) {
          Ee(be(this.config.urls.youtube.api, e))
            .then((e) => {
              if (x.object(e)) {
                const { title: t, height: i, width: s } = e;
                ((this.config.title = t),
                  Be.setTitle.call(this),
                  (this.embed.ratio = ge(s, i)));
              }
              pe.call(this);
            })
            .catch(() => {
        ...
        ready() {
          ...
          if (!x.empty(i) && i.startsWith("youtube-")) return;
          ...
          if (((e.media = F(a, e.media)), t.customControls)) {
            const t = (e) => `https://i.ytimg.com/vi/${n}/${e}default.jpg`;
            Ue(t("maxres"), 121)
              .catch(() => Ue(t("sd"), 121))
              .catch(() => Ue(t("hq")))
              .then((t) => Be.setPoster.call(e, t.src))
              .then((t) => {
                t.includes("maxres") ||
          ...
          e.embed = new window.YT.Player(e.media, {
            ...
            events: {
              ...
              onReady(i) {
                if (x.function(e.media.play)) return;
                const s = i.target;
                (it.getTitle.call(e, n),
                  (e.media.play = () => {
                    (et.call(e, !0), s.playVideo());
                  }),
                  (e.media.pause = () => {
                    (et.call(e, !1), s.pauseVideo());
                  }),
                  (e.media.stop = () => {
                    s.stopVideo();
                  }),
                ...
                ((e.options.speed = r.filter((t) =>
                  ...
                  t.customControls && setTimeout(() => Be.build.call(e), 50));
              },
              onStateChange(i) {
                const s = i.target;
                ...
                switch (
                  ...
                  case 1:
                    ...
                    break;
                  case 2:
                    (e.muted || e.embed.unMute(), et.call(e, !1));
                    break;
                  case 3:
                    se.call(e, e.media, "waiting");
                }
          ...
          this.media
            ? (B(
              ...
              this.isVideo &&
                ...
                O(this.media, this.elements.wrapper),
    ...
    class nt {
        ...
        (e(this, "load", () => {
          ...
          e(this, "pollCountdown", (e = !1) => {
            ...
            this.countdownTimer = setInterval(() => {
              const e = Ne(Math.max(this.manager.getRemainingTime(), 0)),
                t = `${Ae.get("advertisement", this.player.config)} - ${e}`;
      ...
      get tagUrl() {
        ...
        return `https://go.aniview.com/api/adserver6/vast/?${Ie({ AV_PUBLISHERID: "58c25bb0073ef448b1087ad6", AV_CHANNELID: "5a0458dc28a06145e4519d21", AV_URL: window.location.hostname, cb: Date.now(), AV_WIDTH: 640, AV_HEIGHT: 480, AV_CDIM2: e.publisherId })}`;
      }
    }
    ...
    function lt(e) {
      ...
      return (
        e.split(/\r\n\r\n|\n\n|\r\r/).forEach((e) => {
          const i = {};
          (e.split(/\r\n|\n|\r/).forEach((e) => {
            if (x.number(i.startTime)) {
              if (!x.empty(e.trim()) && x.empty(i.text)) {
            ...
            if (
              ...
              if ("touchmove" === e.type)
                ...
                ((this.seekTime = this.player.media.duration * (n / 100)),
                  ...
                  (this.elements.thumb.time.textContent = Ne(this.seekTime)));
                const a =
          ...
          ? (fe.cancelRequests.call(this),
            this.destroy(() => {
              ...
              (Object.assign(this, {
                ...
                x.boolean(e.autoplay) && (this.config.autoplay = e.autoplay),
                this.isHTML5 &&
                  (this.config.crossorigin &&
                    this.media.setAttribute("crossorigin", ""),
                  this.config.autoplay &&
                    this.media.setAttribute("autoplay", ""),
                  x.empty(e.poster) || (this.poster = e.poster),
                ...
                x.empty(e.previewThumbnails) ||
                  ...
                  this.config.previewThumbnails.enabled &&
                    (this.previewThumbnails = new ot(this))),
    ...
    class ut {
      constructor(t, i) {
        if (
          ...
          e(this, "pause", () =>
            this.playing && x.function(this.media.pause)
              ? this.media.pause()
              : null,
          ),
          e(this, "togglePlay", (e) =>
            (x.boolean(e) ? e : !this.playing) ? this.play() : this.pause(),
          ),
          e(this, "stop", () => {
            this.isHTML5
          ...
          e(this, "destroy", (e, t = !1) => {
              ...
              ((document.body.style.overflow = ""),
                ...
                t
                  ? (Object.keys(this.elements).length &&
                      (H(this.elements.buttons.play),
                      H(this.elements.captions),
                      H(this.elements.controls),
                      H(this.elements.wrapper),
                  ...
                  : (ne.call(this),
                    fe.cancelRequests.call(this),
                    F(this.elements.original, this.elements.container),
                    se.call(this, this.elements.original, "destroyed", !0),
                    x.function(e) && e.call(this.elements.original),
                    (this.ready = !1),
                    setTimeout(() => {
            ...
            (this.stop(),
              ...
              this.isHTML5
                ? (Be.toggleNativeControls.call(this, !0), i())
                : this.isYouTube
          ...
          e(this, "supports", (e) => J.mime.call(this, e)),
          (this.timers = {}),
          (this.ready = !1),
          (this.loading = !1),
          (this.failed = !1),
        ...
        switch (n) {
          case "div":
            if (((a = this.media.querySelector("iframe")), x.element(a))) {
              if (
                ((l = Le(a.getAttribute("src"))),
            ...
            if (
              ...
              !Object.values(qe).includes(this.provider)
            )
        ...
        ((this.supported = J.check(this.type, this.provider)),
          this.supported.api
            ? ((this.eventListeners = []),
              (this.listeners = new We(this)),
              (this.storage = new Se(this)),
              (this.media.plyr = this),
              x.element(this.elements.container) ||
                ((this.elements.container = q("div")),
                O(this.media, this.elements.container)),
              Be.migrateStyles.call(this),
              Be.addStyleHook.call(this),
              st.setup.call(this),
              this.config.debug &&
                ee.call(
      ...
      get isHTML5() {
        return this.provider === qe.html5;
      }
      get isEmbed() {
        return this.isYouTube || this.isVimeo;
      }
      get isYouTube() {
        return this.provider === qe.youtube;
      }
      get isVimeo() {
        return this.provider === qe.vimeo;
      }
      get isVideo() {
        return this.type === He;
      }
      ...
      get duration() {
        const e = Number.parseFloat(this.config.duration),
          t = (this.media || {}).duration,
          i = x.number(t) && t !== 1 / 0 ? t : 0;
        return e || i;
      }
      set volume(e) {
        let t = e;
        (x.string(t) && (t = Number(t)),
          ...
          x.number(t) || ({ volume: t } = this.config),
          t > 1 && (t = 1),
          t < 0 && (t = 0),
      ...
      set speed(e) {
        let t = null;
        (x.number(e) && (t = e),
          x.number(t) || (t = this.storage.get("speed")),
          x.number(t) || (t = this.config.speed.selected));
      ...
      set loop(e) {
        const t = x.boolean(e) ? e : this.config.loop.active;
      ...
      set download(e) {
        x.url(e) &&
          ((this.config.urls.download = e), xe.setDownloadUrl.call(this));
      }
      set poster(e) {
        this.isVideo
          ? Be.setPoster.call(this, e, !1).catch(() => {})
      ...
      get ratio() {
        ...
        const e = de(me.call(this));
        return x.array(e) ? e.join(":") : e;
      }
      set ratio(e) {
        this.isVideo
          ? x.string(e) && he(e)
            ? ((this.config.ratio = de(e)), pe.call(this))
            : this.debug.error(`Invalid aspect ratio specified (${e})`)
          : this.debug.warn("Aspect ratio can only be set for video");
      }
      set autoplay(e) {
        this.config.autoplay = x.boolean(e) ? e : this.config.autoplay;
      }
      get autoplay() {
        return Boolean(this.config.autoplay);
      }
      toggleCaptions(e) {
        $e.toggle.call(this, e, !1);
      }
      set currentTrack(e) {
        ($e.set.call(this, e, !1), $e.setup.call(this));
      }
      get currentTrack() {
      ...
      set pip(e) {
        if (!J.pip) return;
        const t = x.boolean(e) ? e : !this.pip;
        (x.function(this.media.webkitSetPresentationMode) &&
          this.media.webkitSetPresentationMode(t ? Oe : je),
      ...
      get pip() {
        return J.pip
          ? x.empty(this.media.webkitPresentationMode)
            ...
            : this.media.webkitPresentationMode === Oe
          : null;
      }
      ...
      static setup(e, t = {}) {
        ...
        return (
          ...
          x.empty(i) ? null : i.map((e) => new ut(e, t))
        );
      }
    }
    var ht;
    return ((ut.defaults = ((ht = _e), JSON.parse(JSON.stringify(ht)))), ut);
  });
